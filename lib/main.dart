...
import 'package:auto_food/splachScreen.dart';
        ...
        verificationCompleted: (AuthCredential credential) async {
          ...
          if (user != null) {
            ...
            Navigator.of(context).pushNamedAndRemoveUntil(
                '/loadpage', (Route<dynamic> route) => false);
          } else {
            print('error');
          }
        },
                ...
                Center(
                  child: Padding(
                    padding: const EdgeInsets.only(
                        left: 20.0, top: 25.0, right: 20.0, bottom: 4.0),
                    child: Material(
                      shape: RoundedRectangleBorder(
                      ...
                      child: GroovinExpansionTile(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(
                              "AIDbot is an online Application for controlling and placing orders via an Autonomous Indoor Delivery Vehicle",
                              style: GoogleFonts.happyMonkey(
                                  color: Colors.white,
                                  fontSize:
                                      MediaQuery.of(context).size.width * 0.045,
                          ...
                          Padding(
                            ...
                            child: Card(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                    "Please Login/SignUp in order to procede !",
                                    style: GoogleFonts.happyMonkey(
                                        fontSize:
                                            MediaQuery.of(context).size.width *
                                                0.045,
                      ...
                      children: <Widget>[
                        Padding(
                          padding: const EdgeInsets.symmetric(
                              horizontal: 20.0, vertical: 8.0),
                          child: Text(
                            "Make sure your Store is registered on the App !",
                            style: GoogleFonts.happyMonkey(
                                color: Colors.black87,
                                fontSize:
                                    MediaQuery.of(context).size.width * 0.045,
                ...
                child: Card(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      ListTile(
                        leading: (status == "Number Verified :)" ||
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                                  ...
                                  child: Material(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelStyle: GoogleFonts.happyMonkey(
                                            fontSize: MediaQuery.of(context)
                                                    .size
                                                    .width *
                                                0.04),
                            ...
                            if (!phonesignup)
                              Padding(
                                padding: const EdgeInsets.only(
                                    left: 20, right: 20, top: 9.0, bottom: 5.0),
                                child: Material(
                                  elevation: 5.0,
                                  borderRadius:
                                      BorderRadius.all(Radius.circular(5.0)),
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: CachedNetworkImage(
                            imageUrl:
                                "https://firebasestorage.googleapis.com/v0/b/twigger-93153.appspot.com/o/wallpapers%2Fic_launcher.png?alt=media&token=c661070d-9bb9-4f09-860b-c029827a7718",
